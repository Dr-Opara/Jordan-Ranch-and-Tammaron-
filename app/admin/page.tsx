...
import { ShieldCheck, Store, CalendarDays } from "lucide-react";
...
export default function AdminHome(){
  ...
  return <main className="auth-page"><section className="auth-card wide"><Link href="/" className="auth-brand">Jordan Ranch & Tamarron</Link><span className="badge">Platform Admin</span><h1>Admin Center</h1><p className="auth-copy">Manage private resident access, local business advertising, and informational community content.</p>
