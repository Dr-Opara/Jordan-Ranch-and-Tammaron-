...
export default function AdvertiserDashboard(){
 ...
 return <main className="auth-page"><section className="auth-card wide">
  ...
  <article className="card" style={{marginTop:14}}><div className="card-body"><div className="eyebrow">Advertising Plan</div><div className="card-title">{plan}</div><div className="cta-row"><Link className="btn-primary" href="/advertise/plans" style={{textAlign:"center",textDecoration:"none"}}>View Advertising Plans</Link></div></div></article>
