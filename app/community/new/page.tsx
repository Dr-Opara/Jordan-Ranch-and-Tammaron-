...
export default function NewCommunityPostPage() {
  ...
  return <main className="auth-page"><section className="auth-card wide">
    ...
    <form className="form-stack" onSubmit={submit}>
      ...
      <label>Headline<input required minLength={3} maxLength={120} value={title} onChange={e=>setTitle(e.target.value)} placeholder="What is happening?"/></label>
      <label>Details<textarea required minLength={1} maxLength={2000} value={body} onChange={e=>setBody(e.target.value)} placeholder="Share the useful details residents should know."/></label>
