...
export default async function Page() {
  ...
  const [totalResult,jordanResult,tamarronResult,listingsResult,businessesResult,homeAdsResult,localAdsResult,dealsResult,updatesResult,eventsResult] = await Promise.all([
